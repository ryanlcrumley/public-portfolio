...
### [snow-wildfire-toolkit](https://github.com/ryanlcrumley/snow-wildfire-toolkit)
...
### VisibleSnow — Private Research Project

Machine learning and computer-vision workflows for estimating snow cover from visible-wavelength imagery, including unsupervised classification and TabPFN-based prediction.
...
**Demonstrates:** Scientific computing · workflow design · data assimilation · prototyping · collaborative software development
...
- **Scientific communication:** connecting computational methods with peer-reviewed research and publications

## Public and Private Work

The public repositories here are a **selection rather than a complete record of my work**.

Some of my professional and research work involves proprietary code, unpublished research, internal systems, or other material that cannot currently be released publicly. Where appropriate, I have included those projects with a description of the work and my contribution, but without exposing restricted code or data.

The goal of this portfolio is therefore not to represent everything I have worked on, but to provide a representative view of **how I approach scientific, data, and machine learning problems and how I contribute to collaborative technical projects.**

## More

For additional information about my background and experience, see my [GitHub profile](https://github.com/ryanlcrumley) and professional materials.

---

*This portfolio is a work in progress. Projects and documentation will continue to evolve as work becomes publicly shareable.*
